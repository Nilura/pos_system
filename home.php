                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="admin/assets/images/Ashen.jpg" class="img-radius" alt="User-Profile-Image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-40 img-radius" src="admin/assets/images/Ashen.jpg" alt="User-Profile-Image">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="deleteuser.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">User Control</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="retrive.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Details</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="search.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Search</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                        ...
                                        <li class=" ">
                                            <a href="https://myweb-72a93.firebaseapp.com/">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">#corders</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li>
                                    <a href="https://stapp-7c06c.firebaseapp.com/index.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Stapp</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <span class="text-c-blue f-w-600">Date&Time</span>
                                                        <h4><p id="datetime" class="d1"></p></h4>
                                                        <div>
                                                            <span class="f-left m-t-10 text-muted">
                                                                <i class="text-c-blue f-16 icofont icofont-warning m-r-10"></i>Time
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <span class="text-c-green f-w-600">Records</span>
                                                        <h4><?php require_once('config.php');
...
?></h4>
                                                        <div>
                                                            <span class="f-left m-t-10 text-muted">
                                                                <i class="text-c-green f-16 icofont icofont-tag m-r-10"></i>Number of users
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="elfsight-app-590c6b87-9776-4441-95bb-9eebb2842dbf"></div>
                                                    ...
                                                    <div class="card fb-card">
                                                        <div class="card-header">
                                                            ...
                                                            <div class="d-inline-block">
                                                               <script src="https://apps.elfsight.com/p/platform.js" defer></script>
<div class="elfsight-app-465f90f6-dc36-4868-a25b-003edbbca3a7"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card dribble-card">
                                                        <div class="card-header">
                                                            ...
                                                            <div class="d-inline-block">
                                                           <script src="https://apps.elfsight.com/p/platform.js" defer></script>
<div class="elfsight-app-3fcaf114-6736-4503-80ac-505220c6bd09"></div>
                                                            </div>
                                                        </div>
                                                        <div class="card-block text-center">
                                                            <div class="row">
                                                    ...
                                                    <div class="card twitter-card">
                                                          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.4912156502737!2d79.89701681415177!3d7.068903018545067!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2f0b52ccd10c3%3A0x0!2zN8KwMDQnMDguMCJOIDc5wrA1Myc1Ny4xIkU!5e0!3m2!1sen!2slk!4v1588295440211!5m2!1sen!2slk" width="300" height="250" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                                        <div class="card-block text-center">
                                                            <div class="row">
                                            ...
                                            <div class="col-md-12 col-xl-6">
                                                <div class="card add-task-card">
                                                    ...
                                                    <div class="card-block">
                                                      ...
                                                      <script src="https://apps.elfsight.com/p/platform.js" defer></script>
<div class="elfsight-app-19f48100-5027-4f2c-a596-fbcbc522a62a"></div>
                                                    </div>
                                                </div>
                                                <!-- Data widget End -->
                ...
                <div class="fixed-button">
                    <a href="https://todoashen.herokuapp.com/" target="_blank" class="btn btn-md btn-primary">
                      <i class="fa fa-shopping-cart" aria-hidden="true"></i> Todo
                    </a>
                </div>
            </div>
        </div>
...
<script src="admin/assets/js/demo-12.js"></script>
